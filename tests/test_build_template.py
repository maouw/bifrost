...
class TestBuildTemplateCommand:
    """Tests for the build_template command functionality."""

    def test_build_template_basic_workflow(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
    ...
    def test_build_template_with_directory_input(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
        ...
        args = argparse.Namespace(
            input=[str(input_dir)],  # Pass directory instead of individual files
            output=str(output_dir),
            reference_image=None,
            affine_steps=1,
            syn_steps=1,
    ...
    def test_build_template_with_reference_image(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
    ...
    def test_build_template_with_clahe_preprocessing(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
    ...
    def test_build_template_with_mirror(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
    ...
    def test_build_template_keep_intermediates(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
    ...
    def test_build_template_multiple_affine_steps(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
    ...
    def test_build_template_force_overwrite(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
    ...
    def test_build_template_custom_log(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
...
class TestBuildTemplateInputValidation:
    """Tests for input validation in build_template command."""

    def test_build_template_missing_input(self, tmp_path: Path) -> None:
        """Test error when input files don't exist."""
        output_dir = tmp_path / "output"

        args = argparse.Namespace(
            input=[str(tmp_path / "nonexistent.nii")],
            output=str(output_dir),
            reference_image=None,
            affine_steps=1,
            syn_steps=1,
    ...
    def test_build_template_missing_reference(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
        ...
        args = argparse.Namespace(
            input=[str(img_path)],
            output=str(output_dir),
            reference_image=str(tmp_path / "nonexistent_reference.nii"),
            affine_steps=1,
            syn_steps=1,
            gradient_step=0.1,
            preprocessing=None,
    ...
    def test_build_template_output_exists_no_force(self, tmp_path: Path, sample_3d_image: ants.ANTsImage, caplog: pytest.LogCaptureFixture) -> None:
