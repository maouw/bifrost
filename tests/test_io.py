...
class TestImageIO:
    ...
    def test_read_image_to_file(self, tmp_path: Path, sample_3d_image: ants.ANTsImage) -> None:
        ...
        loaded_image = ants.image_read(image_path)
        np.testing.assert_array_almost_equal(sample_3d_image.numpy(), loaded_image.numpy())
...
class TestUtilityFunctions:
    ...
    def test_read_weights_inshape(self, mock_weights_file: Path) -> None:
    ...
    def test_read_weights_inshape_missing_attr(self, tmp_path: Path) -> None:
    ...
    def test_read_weights_inshape_invalid_json(self, tmp_path: Path) -> None:
    ...
    def test_read_weights_inshape_wrong_type(self, tmp_path: Path) -> None:
